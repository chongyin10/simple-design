import {projectId, userId} from "../utils/cookie"
/*url相关的操作*/
...
export function getRootKey() {
  const rootKey = window.localStorage.getItem('rootKey')
  return rootKey? rootKey :''
}
export function saveRootKey(key){
   window.localStorage.setItem('rootKey','')
}
export function removeRootKey() {
