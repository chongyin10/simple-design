...
import { I18nProvider, i18n, useI18n } from '../components';
...
const App: React.FC = () => {
    ...
    const menuItems = [
        { id: 'intro', name: t('INTRO') },
        { id: 'install', name: t('INSTALL') },
        { id: 'i18n', name: t('I18N') },
        { id: 'button', name: t('BUTTON') },
        { id: 'colorpicker', name: t('COLORPICKER') },
        { id: 'copytoclipboard', name: t('COPYTOCLIPBOARD') },
        { id: 'divider', name: t('DIVIDER') },
        { id: 'empty', name: t('EMPTY') },
        { id: 'flex', name: t('FLEX') },
        { id: 'icon', name: t('ICON') },
        { id: 'input', name: t('INPUT') },
        { id: 'marquee', name: t('MARQUEE') },
        { id: 'message', name: t('MESSAGE') },
        { id: 'modal', name: t('MODAL') },
        { id: 'notice', name: t('NOTICE') },
        { id: 'notification', name: t('NOTIFICATION') },
        { id: 'radio', name: t('RADIO')},
        { id: 'select', name: t('SELECT')},
        { id: 'table', name: t('TABLE')},
        { id: 'top', name: t('TOP') },
        { id: 'typography', name: t('TYPOGRAPHY') },
        { id: 'variables', name: t('VARIABLES') },
        { id: 'api', name: t('API_REF') },
    ];
    ...
    const components: ComponentItem[] = [
        { id: 'i18n', name: '国际化', description: '组件库国际化支持' },
